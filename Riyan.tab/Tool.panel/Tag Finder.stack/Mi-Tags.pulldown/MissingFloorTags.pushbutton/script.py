# -*- coding: utf-8 -*-
"""Selects floors with no associated tags in current view. (Riyan)"""
__doc__ = "Selects floors with no associated tags in current view."
__title__ = "Missing Floor\nTag Finder"
...
target = Taggable(
    tag_type=DB.BuiltInCategory.OST_FloorTags,
    element_type=DB.BuiltInCategory.OST_Floors
)
...
if untagged_elements and tagged_elements:
    ...
    forms.alert('All floors in current view have tags.')
elif not tagged_elements:
    forms.alert('No floors in current view have tags.')
