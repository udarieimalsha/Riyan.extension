# -*- coding: utf-8 -*-
"""Selects rebars with no associated tags in current view. (Riyan)"""
__doc__ = "Selects rebars with no associated tags in current view."
__title__ = "Missing Rebar\nTag Finder"
...
target = Taggable(
    tag_type=DB.BuiltInCategory.OST_RebarTags,
    element_type=DB.BuiltInCategory.OST_Rebar
)
...
if untagged_elements and tagged_elements:
    ...
    forms.alert('All Rebars in current view have tags.')
elif not tagged_elements:
    forms.alert('No Rebars have tags.')
