# -*- coding: utf-8 -*-
"""Selects rebars with duplicate tags in current view. (Riyan)"""
__doc__ = "Selects rebars with duplicate tags in current view."
__title__ = "Duplicate Rebar\nTag Finder"
...
if dupes_id:
    ...
    forms.alert('No rebars with duplicate tags found')
