...
class ConnectionWindow(WPF.Window):
    ...
    def OnRun(self, sender, args):
        ...
        self.result = {"elements": selected_elements, "conn_type": selected_item.Tag}
        self.ui.Close()
...
def get_structural_connection_types():
    return FilteredElementCollector(doc).OfClass(StructuralConnectionHandlerType).WhereElementIsElementType().ToElements()
